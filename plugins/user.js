      ...
      if (!_0x354e18 && _0x5b9714.isGroup) {
        const _0x561b75 =
          (await _0x5b9714.bot
            ...
            .catch(
              (_0x1c3876) => "https://telegra.ph/file/78fe770577874437b97d8.jpg"
            )) || THUMB_IMAGE;
        ...
        try {
          ...
          _0x5ae446 = "https://telegra.ph/file/78fe770577874437b97d8.jpg";
        }
    ...
    try {
      ...
      const botcap =
        !/fresh|reset|new|why|update/g.test(label) && checkme[randoms]
          ? checkme[randoms]
          : `*📋 ABOUT @${randoms.split("@")[0]}*\n\n` +
            `*📝 Name :* ${(await message.bot.getName(randoms)).split("\n").join("  ")}\n` +
